...
function default_1(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var args, argv, COMMAND_INITIATED_BY, cliPath, child, adminCLI, loadConfigPath, loadConfig, serve, adminChild_1;
        return __generator(this, function (_b) {
            ...
            if (adminCLI) {
                loadConfigPath = path_1.default.resolve(require.resolve("@medusajs/admin"), "../../", "utils", "load-config.js");
                loadConfig = require(loadConfigPath).loadConfig;
                serve = loadConfig(true).serve;
                if (serve) {
